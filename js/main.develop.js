    ...
    (function ($, backbone, app) {
        ...
        var dropdownModule = backbone.View.extend({
            ...
            optionSelected: function (e) {
                ...
                // console.log(this.SELECTION.value, _this.attr('id'));
            ...
            onToggleAutoclose: function (e, scope) {
                // console.log('onToggleAutoclose', scope.$toggle);
    ...
    (function ($, backbone, app) {
        ...
        function _validateForm(_this, cb) {
            var validators = [
                ...
                {
                    fields: _this.$('[validate-selected]'),
                    fn: _validateSelected
                }
            ];
    ...
    (function ($, backbone, app) {
        ...
        var notificationModule = backbone.View.extend({
            ...
            events: {
                ...
                'click .manage': 'onManageClick',
            },

            initialize: function () {
                var _this = this;
                if (window.location.pathname === '/') {
                    _this.$el.addClass('bottom');
                }
            ...
            onManageClick: function () {
                ...
                window.setTimeout(function () {
                    window.location = '/cookiepolicy#manage';
                }, 400);
            },
        ...
        var webModule = backbone.View.extend({
                ...
                var sets = [
                    {
                        textParams: {
                            ...
                            textColor: { r: 256, g: 256, b: 256, a: 0.95 },
                        ...
                        points: [
                            ...
                            { label: '    BRAND_CONTENT', connections: [1], url: '/expertise', cVParents: [1], img: './img/BRAND_CONTENT.png' },
                            ...
                            { label: '  MOTOGP', connections: [3, 4, 5], url: '/expertise', cVParents: [1], img: './img/MOTOGP.png' },
                            { label: '          ARTS', connections: [0], url: 'http://google.com/', cVParents: [1], img: './img/ARTS.png' },
                            { label: '    BRAND_CONTENT', connections: [1], url: '/expertise', cVParents: [1], img: './img/BRAND_CONTENT.png' },
                            { label: '        CULTURA', connections: [1], url: '/expertise/music', cVParents: [1], img: './img/CULTURA.png' },
                            { label: '        DIGITAL', connections: [0, 1, 2], url: '/expertise', cVParents: [1], img: './img/DIGITAL.png' },
            ...
            animate: function () {
                ...
                for (var i = 0; i < geomLength; i++) {
                    //movement update
                    var p = this.points[i];
                    var pX = p.startPosition[0] * Math.cos(this.tickRotate) + p.startPosition[2] * Math.sin(this.tickRotate),
            ...
            makeTextSprite: function (message, parameters) {
                ...
                if (this.isWebGL) {
                    sprite.scale.set(0.075 * fontsize * 0.8, 0.0325 * fontsize * 0.8, 0.1125 * fontsize * 0.8);
                }
                else {
                    sprite.scale.set(1.3 * fontsize, 0.75 * fontsize, 2.25 * fontsize);
                }
    ...
    (function ($, backbone, app) {
        var officePage = backbone.View.extend({
            ...
            parseOffices: function (data) {
                var GROUPS = ['AMERICAS', 'EUROPE/MIDDLE EAST/AFRICA', 'ASIA PACIFIC'];
                return GROUPS.map(function (group) {
                    ...
                    var wmeOffices = regionOffices.filter(function (office) {
                        return !office.is_featured && office.company === 'WME';
                    });

                    var imgOffices = regionOffices.filter(function (office) {
                        return !office.is_featured && office.company === 'IMG';
                    });

                    return {
                        region: group,
                        featured: featured,
                        hasExtra: wmeOffices.length > 0 || imgOffices.length > 0,
                        wme: wmeOffices,
                        img: imgOffices
                    };
                });
